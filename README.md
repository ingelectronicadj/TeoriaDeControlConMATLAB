# Teoria de Sistemas de Control con MATLAB
Este repositorio es de utilidad para aprender y/o recordar algunos temarios teorico-practicos de los sistemas de control

## Diagramas de Nyquist
![grafo](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-12.png?raw=true "grafo")

![grafo2](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-13.png?raw=true "grafo2")

![grafo3](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-18.png?raw=true "grafo3")

![grafo4](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-19.png?raw=true "grafo4")

![grafo5](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-21.png?raw=true "grafo5")

## Diagramas de Bode
![grafo](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-25.png?raw=true "grafo")

![grafo2](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-33-c.png?raw=true "grafo2")

![grafo3](https://github.com/ingelectronicadj/TeoriaDeControlConMATLAB/blob/master/todoEnImagenes/B-7-3.png?raw=true "grafo3")
